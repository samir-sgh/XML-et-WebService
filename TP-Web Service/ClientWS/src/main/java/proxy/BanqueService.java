...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getCopmte", targetNamespace = "http://ws/", className = "proxy.GetCopmte")
    @ResponseWrapper(localName = "getCopmteResponse", targetNamespace = "http://ws/", className = "proxy.GetCopmteResponse")
    @Action(input = "http://ws/BanqueService/getCopmteRequest", output = "http://ws/BanqueService/getCopmteResponse")
    public Compte getCopmte(
